...
def show_certifications(user):
    ...
    certifications = [
        {
            "name": "Python & Production Certification",
        ...
        {
            "name": "MLOps Specialist Certification",
            "course": "ML & MLOps",
    ...
    st.info(
        "📭 You haven't earned any certificates yet. Complete courses to earn them!"
    )
